//! End-to-end gRPC integration tests for the ac-enforcer.
//!
...
use ac_enforcer::grpc::proto::enforcer_client::EnforcerClient;
use ac_enforcer::grpc::proto::*;
...
async fn start_enforcer() -> (testcontainers::ContainerAsync<GenericImage>, String) {
    ...
    let container = GenericImage::new("ac-enforcer-test", "latest")
