//! OpenTelemetry pipeline setup and custom attribute constants for agentcontainer-enforcer.
//!
...
/// - `service.name = "agentcontainer-enforcer"`
...
pub fn init_tracer_provider(
    ...
    let resource = Resource::builder()
        .with_attributes([KeyValue::new("service.name", "agentcontainer-enforcer")])
        .build();
