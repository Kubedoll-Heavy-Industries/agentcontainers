...
The package reference can include an optional type prefix:
  agentcontainer shim npm:@modelcontextprotocol/server-github@1.2.3
  agentcontainer shim pypi:mcp-server-fetch@0.6.2
  agentcontainer shim git:https://github.com/user/mcp-server.git@v1.0
  agentcontainer shim @modelcontextprotocol/server-github   (auto-detects npm)
  agentcontainer shim mcp-server-fetch                      (auto-detects pypi)
  agentcontainer shim https://github.com/user/repo.git      (auto-detects git)

For git sources, use @ref to specify a branch, tag, or commit:
  agentcontainer shim git:https://github.com/user/repo.git@main
  agentcontainer shim git:https://github.com/user/repo.git@v1.0.0
...
var npmDockerfileTemplate = template.Must(template.New("npm").Parse(`# Generated by agentcontainer shim
...
var pypiDockerfileTemplate = template.Must(template.New("pypi").Parse(`# Generated by agentcontainer shim
...
var gitDockerfileTemplate = template.Must(template.New("git").Parse(`# Generated by agentcontainer shim
