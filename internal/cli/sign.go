...
Examples:
  agentcontainer sign registry.io/image@sha256:abc123...
  agentcontainer sign --key cosign.key registry.io/image@sha256:abc123...
  agentcontainer sign --keyless --cert-identity user@example.com --cert-issuer https://accounts.google.com registry.io/image@sha256:abc123...
  agentcontainer sign --provenance registry.io/image@sha256:abc123...
  agentcontainer sign --all --key cosign.key
  agentcontainer sign --all --annotation env=production`,
